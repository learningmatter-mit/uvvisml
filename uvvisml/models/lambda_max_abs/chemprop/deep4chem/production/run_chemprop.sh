#!/bin/bash
#SBATCH -p normal
#SBATCH -J uvvis_prod_d4c
#SBATCH -o uvvis_prod_d4c-%j.out
#SBATCH -t 5-00:00:00
#SBATCH -n 1
#SBATCH -N 1
#SBATCH --mem=30gb
...
python $CHEMPROP_DIR/predict.py --test_path $SPLITS_DIR/lambda_max_abs/deep4chem/group_by_smiles/smiles_target_test.csv --checkpoint_dir $(pwd) --preds_path preds.csv --gpu 0 --number_of_molecules 2 --ensemble_variance
