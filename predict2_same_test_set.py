...
arguments = [
    '--data_path', f'../uvvisml/data/splits_same_test_set/{optical_properties}/deep4chem/{split_type}/smiles_target_train.csv',
    '--separate_val_path', f'../uvvisml/data/splits_same_test_set/{optical_properties}/deep4chem/{split_type}/smiles_target_val.csv',
    '--separate_test_path', f'../uvvisml/data/splits_same_test_set/{optical_properties}/deep4chem/{split_type}/smiles_target_test.csv',
...
arguments = [
    '--test_path', f'../uvvisml/data/splits_same_test_set/{optical_properties}/deep4chem/{split_type}/smiles_target_test.csv',
