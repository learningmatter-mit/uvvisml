...
arguments = [
    ...
    '--separate_val_path', os.path.join(CURR_DIR,f'uvvisml/data/{splits_dir}/{optical_properties}/deep4chem/{split_type}/smiles_target_val.csv'),
    '--separate_test_path', os.path.join(CURR_DIR,f'uvvisml/data/{splits_dir}/{optical_properties}/deep4chem/{split_type}/smiles_target_test.csv'),
    '--dataset_type', 'regression',
    '--save_dir', os.path.join(CURR_DIR,f'uvvisml/{models_dir}/{optical_properties}_checkpoints/{split_type}'),
    '--epochs', '100', #100-200
    '--gpu', '0',
...
arguments = [
    '--test_path', os.path.join(CURR_DIR,f'uvvisml/data/{splits_dir}/{optical_properties}/deep4chem/{split_type}/smiles_target_test.csv'),
    '--preds_path', os.path.join(CURR_DIR,f'uvvisml/{models_dir}/{optical_properties}_checkpoints/{split_type}/{optical_properties}_preds.csv'),
    '--checkpoint_dir', os.path.join(CURR_DIR,f'uvvisml/{models_dir}/{optical_properties}_checkpoints/{split_type}'),
    '--number_of_molecules', '2',
    '--smiles_columns', 'smiles', 'solvent'
]
